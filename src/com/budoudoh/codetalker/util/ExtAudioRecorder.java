...
public class ExtAudioRecorder 
{
	...
	*/
	...
	public ExtAudioRecorder(boolean uncompressed, int audioSource, int sampleRate, int channelConfig, int audioFormat)
	{
		try
		{
			...
			{ // RECORDING_COMPRESSED
				Log.i("TEst", "Recording compressed");
	...
	{
		//Log.v("ExtAudioRecorder", "Called getMaxAmplitude()");
		if (state == State.RECORDING)
			
		{
			//Log.v("ExtAudioRecorder", "State: Recording");
			if (rUncompressed)
			{
				//Log.v("ExtAudioRecorder", "Uncompressed");
				int result = cAmplitude;
				//Log.v("ExtAudioRecorder", "Amplitude: " + result);
				cAmplitude = 0;
				return result;
			}
			else
			{
				//Log.v("ExtAudioRecorder", "Not compressed");
				try
				{
					//Log.v("extAudioRecorder", "Getting MaxAmplitude");
		...
		{
			//Log.v("ExtAudioRecorder", "Not recording");
			return 0;
		}
	}
