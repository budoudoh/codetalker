package com.budoudoh.codetalker.keyboard;
...
import com.budoudoh.codetalker.CodeTalker;
import com.budoudoh.codetalker.R;
import com.budoudoh.codetalker.VoiceIntegration;

public class CodeTalkerService extends InputMethodService implements KeyboardView.OnKeyboardActionListener{
	
	private static final boolean PROCESS_HARD_KEYS = true;
	private static final String TAG = "CodeTalkerService";
    ...
    private Handler.Callback gotMessage = new Callback() {
